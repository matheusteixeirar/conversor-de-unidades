...
- O design segue uma abordagem Edge-to-Edge, garantindo que o conteúdo ocupe toda a tela 
- WindowInsetsCompat + ViewCompat.setOnApplyWindowInsetsListener: previne sobreposição com barras de sistema (status bar, navigation bar)
